...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Contra alelo recessivos (Completo)</h1>
            </div>
            <div class="col-sm-6">
            ...
            <div class="card">
                <div class="card-header">
                    <div class="float-left">
                        ...
                        <span>Tem-se que <strong>1 – s</strong>  e <strong> s = 1</strong></span>
                    </div>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6 col-sm-12 col-12" >
                                    ...
                                    <table  style="margin-top:12%; border:1">
                                        <tr>
                                            <th colspan="5">Seleção PARCIAL contra o alelo recessivo ou a favor do dominante</th>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td>A1A1</td>
...
<script src="{{ asset('js/contra_recessivo_completo.js') }}"></script>
@endsection