...
<section class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1>Contra alelo heterozigotos</h1>
            </div>
            <div class="col-sm-6">
                            ...
                            <div class="row">
                                <div class="form-group col-md-6 mt-5">
                                    <div class="row">
                                        <div id="valores">
                                            ...
                                            <div class="form-group col-md-12">
                                                <strong>Coeficiente de Seleção do alelo "A" (s1)<span style="color: red;">*</span></strong>
                                                <input type="text" autocomplete="off" name="s1" id="s1" class="form-control @error('conficiente') is-invalid @enderror" value="{{ old('conficiente') }}">
                                            </div>
                                            <div class="form-group col-md-12">
                                                <strong>Coeficiente de Seleção do alelo "a" (s2)<span style="color: red;">*</span></strong>
                                                <input type="text" autocomplete="off" name="s2" id="s2" class="form-control @error('conficiente') is-invalid @enderror" value="{{ old('conficiente') }}">
                                            </div>
                                ...
                                <div class="form-group col-md-6 col-sm-12 col-12" >
                                    ...
                                    <table  style="margin-top:12%; border:1">
                                        <tr>
                                            <th colspan="5">Superioridade ou Inferioridade do Heterozigoto</th>
                                        </tr>
                                        <tr>
                                            <td></td>
                                            <td>A1A1</td>
...
<script src="{{ asset('js/contra_homozigoto.js') }}"></script>
@endsection
